...
\keywords{algorithms, automata, discrete mathematics} 
...
Notice that $\P''$ is in a normal form and equivalent to $\P$ by an argument analogous to part I in the proof of Theorem~\ref{thm:TdsToTdszo}.
...
In the remaining part of this section we will assume that all instances of \GTDS and \CGTDS are in a normal form. This allows us to consider the problem in the setting of $\beta$-expansions.
...
By the proof of Theorem~\ref{thm:GTdsToGTdszo}, an instance $\P'$ of \CGTDS can be reduced to an instance $\P''$ of \CGTDS in a normal form, where the new target is 
